...
import { EmailOtpModal } from "../components/otpModal";
import { supabase } from "../lib/supabase";
import BillManagement from "./bill-management"; // Import the components directly
